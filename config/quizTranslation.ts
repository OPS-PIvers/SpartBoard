...
/** Every quiz question type is translatable; FIB blanks ride numbered tokens (PR4 reverses D21). */
export function isTranslatableQuestionType(_type: QuizQuestionType): boolean {
  return true;
}
