...
| LOW      | OPEN            | `components/widgets/WorkSymbols/Widget.tsx:115`                   | "Select a symbol below" hand-rolled state — `h-full flex flex-col items-center justify-center text-slate-400` with ImageIcon; visual is simpler than ScaledEmptyState's card wrapper            |
...
| LOW      | OPEN             | `components/admin/CalendarConfigurationModal.tsx:458`                                                             | 1 instance: `label` with canonical anti-pattern (`flex items-center gap-2` modifier — use SettingsLabel icon form or className)                                                                                                                              |
| LOW      | OPEN             | `components/admin/BloomsTaxonomyConfigurationModal.tsx:265`                                                       | 1 instance: `label` with canonical anti-pattern + `flex items-center gap-2`                                                                                                                                                                                  |
| LOW      | OPEN             | `components/admin/TalkingToolConfigurationPanel.tsx:135`                                                          | 1 instance: `label` with exact canonical anti-pattern + `block mb-2`                                                                                                                                                                                         |
| LOW      | OPEN             | `components/admin/SpecialistScheduleConfigurationModal.tsx:385`                                                   | 1 instance: `label` with canonical anti-pattern + `flex items-center gap-2`                                                                                                                                                                                  |
| LOW      | OPEN             | `components/student/NextUpStudentApp.tsx:193`                                                                     | 1 instance in student component — `label` with canonical anti-pattern; confirm whether student-app labels are in D3 scope before converting                                                                                                                  |
...
| LOW      | OPEN            | `hooks/` — ~43 relative imports across ~15 files                                                          | Cross-dir imports to `'../types'`, `'../config/...'`, `'../utils/...'`, `'../context/...'` — next D4 target after context/ complete                                  |
...
- **D4 context/ complete (run 8):** All 8 files, 54 imports converted. Next D4 target: `hooks/` (~43 relative imports across ~15 files), then `utils/` (~22 relative imports).
...
- **D3 next targets (run 9):** Admin config modals still needing conversion: CalendarConfigurationModal.tsx (1 instance, `flex items-center gap-2`), BloomsTaxonomyConfigurationModal.tsx (1 instance), TalkingToolConfigurationPanel.tsx (1 instance), SpecialistScheduleConfigurationModal.tsx (1 instance). Also: NextUpStudentApp.tsx (student component — confirm scope).
