...
| LOW      | OPEN            | `components/widgets/SoundboardWidget/Widget.tsx:384`              | "Select sounds below" hand-rolled state — similar pattern to WorkSymbols; Music icon with opacity-20                                                                                            |
...
| LOW      | OPEN            | `utils/` — ~22 relative imports across ~10 files                                                          | Cross-dir imports to `'../types'`, `'../config/...'`, `'../hooks/...'` — after hooks/ complete                                                                       |
...
- **D4 hooks/ complete (run 9):** All 16 files, 43 imports converted. Next D4 target: `utils/` (~22 relative imports across ~10 files).
