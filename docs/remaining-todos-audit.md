...
**Totals:** 8 code TODO markers triaged (5 legit-pending, 3 stale) · ~70 docs cross-referenced · **24 completed docs deleted** · **2 flagged for your call** · ~40 distinct open items below.
...
| Q4  | **useEffect Grade-D anti-patterns (3):** ActivityWall ShareModal, DiceWidget, QRWidget — cross-widget mutation / ref-sync / derived-state-with-side-effects. ~1 hr total.                                            | `docs/useEffect_audit.md`                                 |  Med   |  S  |
...
| LO6  | **useEffect Grade-C cleanups (15)** — state→ref syncs / chained updates; opportunistic (DriveFileAttachment ×3, Checklist Settings ×3, …). ~3 hrs.                                                                      | `docs/useEffect_audit.md`                                                      |  S  |
