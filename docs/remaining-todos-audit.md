...
**Totals (verified):** ~20 genuinely-open items below · **9 found already-shipped** (removed) · **7 narrowed** · **35 completed docs deleted** (24 first pass + 11 verified-complete plans). **2026-06-24 burndown:** LO1 + Q2 shipped; M4 partially shipped (bulk Resend invite) — see §6.
