...
- [ ] **M5**: finish the `/subs` Collections stub — the live directory, deep links and board navigation in [docs/plans/SUB_SHARE_COLLECTIONS.md](docs/plans/SUB_SHARE_COLLECTIONS.md). Drive grants for Collection shares are done. (M/MED)
