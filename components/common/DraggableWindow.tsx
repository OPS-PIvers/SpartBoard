...
export const DraggableWindow: React.FC<DraggableWindowProps> = ({
  ...
  const content = (
    <GlassCard
      ...
      {...tourAttr('widget.window', widget.id, widget.type)}
        ...
        >
          {showMaxMenu && (
            ...
            >
              <IconButton
                ...
                {...tourAttr('widget.settings-opener', widget.id, widget.type)}
                onClick={(e) => {
                  e.stopPropagation();
                  if (isLocked) return;
                  if (!widget.flipped) markSettingsOpenedLocally(widget.id);
          ...
          <div className="flex items-center gap-3">
            ...
            <IconButton
              ...
              {...tourAttr('widget.restore', widget.id, widget.type)}
              onClick={(e) => {
                e.stopPropagation();
                handleMaximizeToggle();
              }}
      ...
      {showTools &&
        ...
        createPortal(
          <div
            ref={menuRef}
            data-settings-exclude
            {...tourAttr('widget.toolbar', widget.id, widget.type)}
            style={menuStyle}
            ...
            <div className="flex items-center min-w-0 px-2">
              {isEditingTitle ? (
                ...
                <div className="flex items-center gap-1">
                  <div
                    ...
                    {...tourAttr('widget.title', widget.id, widget.type)}
                    onClick={() => {
                      if (isLocked) return;
                      setTempTitle(widget.customTitle ?? title);
              ...
              <div className="flex items-center gap-1">
                <IconButton
                  ...
                  {...tourAttr('widget.pin', widget.id, widget.type)}
                  label={
                    isPinned
                ...
                <IconButton
                  ...
                  {...tourAttr('widget.annotate', widget.id, widget.type)}
                  size="sm"
                  variant="glass"
                  active={isAnnotating}
                  disabled={isLocked}
                ...
                <IconButton
                  ...
                  {...tourAttr('widget.duplicate', widget.id, widget.type)}
                  size="sm"
                  variant="glass"
                  disabled={isLocked}
                />
                ...
                <div className="relative flex items-center">
                  <IconButton
                    ...
                    {...tourAttr('widget.snap-layout', widget.id, widget.type)}
                    size="sm"
                    variant="glass"
                    active={showSnapMenu}
                ...
                {isLocked ? (
                  ...
                  <IconButton
                    ...
                    {...tourAttr('widget.close', widget.id, widget.type)}
                    size="sm"
                    variant="danger"
