...
export const GlobalPermissionsManager: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      {(() => {
        const sortedFeatures = [...GLOBAL_FEATURES].sort((a, b) =>
                          ...
                          <div className="flex flex-wrap gap-2 mb-3">
                            {permission.betaUsers.map((email) => (
                              ...
                              >
                                ...
                                <button
                                  onClick={() =>
                                    removeBetaUser(feature.id, email)
                                  }
                    ...
                    {feature.id === 'gemini-functions' && (
                      <div className="mb-6 p-4 bg-purple-50 rounded-xl border border-purple-100">
                        ...
                        <p className="text-xxs text-purple-500 mt-2 leading-tight">
                          Administrators have unlimited usage. Standard users
                          will see a &quot;limit reached&quot; message after
