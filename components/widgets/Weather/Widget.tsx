    ...
    <WidgetLayout
      ...
      content={
        <div
          ...
          style={{
            gap: hideClothing ? '1cqh' : 'min(12px, 2.5cqmin)',
        ...
        >
          ...
          >
            <div
              ...
              style={{
                gap: hideClothing ? 'min(4cqh, 2cqw)' : 'min(24px, 6cqmin)',
              }}
            >
              <div
                style={{
                  fontSize: hideClothing ? 'min(65cqh, 30cqw)' : '22cqmin',
                }}
              >
                {getIcon('1em')}
              </div>
              <div
                ...
                style={{
                  fontSize: hideClothing ? 'min(75cqh, 40cqw)' : '35cqmin',
                  color: fontColor,
                }}
              >
