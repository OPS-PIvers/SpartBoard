...
> = ({
  ...
  return (
    <div className="w-full h-full rounded-[var(--window-radius,0px)] overflow-hidden relative bg-gradient-to-br from-slate-900 via-slate-800 to-green-950 flex flex-col">
      <div
