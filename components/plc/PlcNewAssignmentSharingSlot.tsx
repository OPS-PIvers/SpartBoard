...
interface PlcNewAssignmentSharingSlotProps {
  ...
  /** Sheet controls render only when this group is supplied (VA modal); the quiz modal omits it. */
  sheet?: {
    ...
    /** Truthy iff signed into Google; falsy + auto ON shows the no-sheet hint. */
  ...
  return (
    <div className="border-t border-slate-200/70 pt-3 space-y-3">
      ...
      <div className="space-y-3 bg-slate-50 rounded-xl p-3 border border-slate-100">
        <div>
          ...
          <p className="text-xxs text-slate-400 mt-0.5">
            {sheet
              ...
              : t('plcDashboard.newAssignment.sharing.teacherNameHintPooled', {
                  defaultValue:
                    'Labels your classes in the pooled PLC results.',
                })}
          </p>
        </div>
        {sheet && (
          <ToggleRow
            ...
            checked={sheet.useAutoGenerated}
            onChange={sheet.onUseAutoGeneratedChange}
            hint={
              sheet.useAutoGenerated
        ...
        {sheet && !sheet.useAutoGenerated && (
          <div>
            ...
            <input
              ...
              onChange={(e) => sheet.onPlcSheetUrlChange(e.target.value)}
              placeholder={t(
        ...
        {sheet && sheet.useAutoGenerated && !sheet.googleAccessToken && (
