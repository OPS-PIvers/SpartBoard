...
export const LoginScreen: React.FC = () => {
  ...
  if (loading) {
    return (
      <div className="relative h-screen w-screen flex items-center justify-center bg-slate-50 overflow-hidden">
        {/* Subtle radial dotted background */}
        <div className="absolute inset-0 bg-[radial-gradient(#e5e7eb_1px,transparent_1px)] [background-size:16px_16px] opacity-50" />

        {/* Soft decorative blur orbs */}
        <div className="absolute top-1/4 -left-1/4 w-[500px] h-[500px] bg-brand-blue-primary/10 rounded-full blur-[100px] animate-pulse" />
  ...
  return (
    <div className="relative h-screen w-screen flex items-center justify-center bg-slate-50 overflow-hidden font-sans">
      ...
      {/* Soft decorative blur orbs */}
      <div className="absolute top-1/4 -left-1/4 w-[500px] h-[500px] bg-brand-blue-primary/20 rounded-full blur-[100px] animate-pulse" />
      <div className="absolute -bottom-1/4 -right-1/4 w-[500px] h-[500px] bg-brand-red-primary/10 rounded-full blur-[100px] animate-pulse delay-1000" />
