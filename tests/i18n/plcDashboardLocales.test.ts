...
const REQUIRED_NOTES_KEYS = [
  ...
  'actionItems.view.sortLabel',
  'actionItems.view.sortManual',
  'actionItems.view.sortStatus',
  'actionItems.view.sortDue',
  'actionItems.view.sortAssignee',
  'actionItems.view.sortCreated',
  'actionItems.view.sortText',
  'actionItems.view.statusLabel',
  'actionItems.view.statusAll',
  'actionItems.view.statusOpen',
  'actionItems.view.statusDone',
  'actionItems.view.dueLabel',
  'actionItems.view.dueAll',
  'actionItems.view.dueOverdue',
  'actionItems.view.dueToday',
  'actionItems.view.dueWeek',
  'actionItems.view.dueNone',
  'actionItems.view.assigneeLabel',
  'actionItems.view.assigneeAll',
  'actionItems.view.showing',
  'actionItems.view.clear',
  'actionItems.view.noMatches',
  'actionItems.view.reorder',
  'actionItems.view.dragHint',
  'importTodos.banner',
  'importTodos.button',
  'importTodos.success',
  'importTodos.failed',
