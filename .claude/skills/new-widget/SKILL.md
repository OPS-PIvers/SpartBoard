...
<WidgetLayout
  padding="p-0"
  content={<div className="h-full w-full bg-white rounded-3xl">...</div>}
/>
```
...
| Building-defaults consumption       | `components/widgets/SpecialistSchedule/SpecialistScheduleWidget.tsx` (sole exception to `Widget.tsx` convention — do not imitate) |
